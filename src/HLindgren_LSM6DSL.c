...
void lsm6dsl_accel_init(Lsm6dsl_Device_t *device, Lsm6dsl_DataRate_e accel_data_rate, Lsm6dsl_FullScaleXl_e full_scale_g)
{
...
void lsm6dsl_gyro_init(Lsm6dsl_Device_t *device, Lsm6dsl_DataRate_e gyro_data_rate, Lsm6dsl_FullScaleGyro_e full_scale_dps)
{
